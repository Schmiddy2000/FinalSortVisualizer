...
namespace sw {
    ...
    Application::Application(sf::RenderWindow &window) : window_(window) {
        ...
        // When adding more than one screen, the screens_ array reallocates its memory leading to a currentScreen
        // that's invalid. As a preliminary solution, reserve a fixed amount of memory for the screens_ array
        screens_.reserve(10);
    }
